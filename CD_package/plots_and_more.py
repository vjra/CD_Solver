...
experiment_list = ['LIGHT_Expri_NOEV_HD_200_alpha_1_epsilon_1_delta_0.0003']
...
for experiment_name in experiment_list:
    ...
    for i in timelist:
        if i[0] == 0.0:
            ...
            t.append(i[0])
            if vtkoutput == True:
                vtk = VTKOutput(ma=mesh,coefs=[gfucalc.components[0],gfucalc.components[1]],names=['rho','c'],filename=pathdirect+'vtk/{}_{}'.format(experiment_name,k),subdivision=2)
                vtk.Do()
        else:
            if k % 10 == 0:
