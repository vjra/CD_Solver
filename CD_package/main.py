...
experiment1 = experiment('Test_version',1,10**(-1),0,10**(-2),0.5,0.03,2,'Unit square',visualoutput_solver)
...
experiment1.plotseries_and_more(make_linftyplot = True,deform_param = 1)
